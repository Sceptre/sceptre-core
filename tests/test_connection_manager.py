...
from sceptre.providers.aws.connection_manager import ConnectionManager, _retry_boto_call
...
class TestConnectionManager(object):
    ...
    def test_repr(self):
        ...
        assert response == "sceptre.providers.aws.connection_manager.ConnectionManager(" \
    ...
    @patch("sceptre.providers.aws.connection_manager.boto3.session.Session")
    ...
    @patch("sceptre.providers.aws.connection_manager.boto3.session.Session.get_credentials")
...
class TestRetry():
    ...
    @patch("sceptre.providers.aws.connection_manager.time.sleep")
