...
from sceptre.providers.aws.stack_status import StackChangeSetStatus
...
class TestStackActions(object):
    ...
    def setup_method(self, test_method):
        self.patcher_connection_manager = patch(
            "sceptre.providers.aws.actions.ConnectionManager"
        )
    ...
    @patch("sceptre.providers.aws.stack.Template")
    ...
    @patch("sceptre.providers.aws.actions.StackActions._wait_for_completion")
    @patch("sceptre.providers.aws.actions.StackActions._get_stack_timeout")
    ...
    @patch("sceptre.providers.aws.actions.StackActions.create")
    @patch("sceptre.providers.aws.actions.StackActions._get_status")
    ...
    @patch("sceptre.providers.aws.actions.StackActions.create")
    @patch("sceptre.providers.aws.actions.StackActions.delete")
    @patch("sceptre.providers.aws.actions.StackActions._get_status")
    ...
    @patch("sceptre.providers.aws.actions.StackActions.update")
    @patch("sceptre.providers.aws.actions.StackActions._get_status")
    ...
    @patch("sceptre.providers.aws.actions.StackActions._describe")
...
"""
    ...
    @patch("sceptre.providers.aws.actions.json")
    ...
    @patch("sceptre.providers.aws.actions.StackActions.set_policy")
    @patch("os.path.join")
    ...
    @patch("sceptre.providers.aws.actions.StackActions._log_new_events")
    @patch("sceptre.providers.aws.actions.StackActions._get_status")
    @patch("sceptre.providers.aws.actions.StackActions._get_simplified_status")
    ...
    @patch("sceptre.providers.aws.actions.StackActions.describe_events")
    ...
    @patch("sceptre.providers.aws.actions.StackActions._get_cs_status")
    ...
    @patch("sceptre.providers.aws.actions.StackActions.describe_change_set")
