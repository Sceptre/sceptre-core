...
from sceptre.providers.connection_manager import ConnectionManager, _retry_boto_call
...
class TestConnectionManager(object):
    ...
    def test_repr(self):
        ...
        assert response == "sceptre.providers.connection_manager.ConnectionManager(" \
    ...
    @patch("sceptre.providers.connection_manager.boto3.session.Session")
    ...
    @patch("sceptre.providers.connection_manager.boto3.session.Session.get_credentials")
...
class TestRetry():
    ...
    @patch("sceptre.providers.connection_manager.time.sleep")
